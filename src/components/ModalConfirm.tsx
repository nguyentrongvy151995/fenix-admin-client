...
export default function ModalConfirm() {
    const {isHiddenPopupConfirm, setHiddenPopupConfirm, setIsConfirm} = useContext(AppContext)
  const handleConfirm = () => {
    setIsConfirm(true)
    setHiddenPopupConfirm(true);
  };
  ...
  return (
    <div
      className={
        'bg-white rounded-lg p-4 z-50 absolute left-[50%] translate-x-[-50%] top-[10%]' +
        (isHiddenPopupConfirm ? ' hidden' : '')
      }
    >
      ...
      <div className="text-center md:text-right mt-4 md:flex md:justify-end">
        <button
          className="block w-full md:inline-block md:w-auto px-4 py-3 md:py-2 bg-[#c62e2e] text-white rounded-lg font-semibold text-sm md:ml-2 md:order-2"
        ...
        <button
          ...
          md:mt-0 md:order-1 bg-[#3b50e0] text-white"
