...
import { commonMessage } from 'src/utils/rules';
...
const SignIn = () => {
  ...
  // const onSubmit = ({userName, password} : {userName: string, password: string}) => console.log(userName, password);
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="">
                  ...
                  <div className="text-red-600 mt-2 h-6">{errors?.userName?.message as string}</div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="text-red-600 mt-2 h-6">{errors?.password?.message as string}</div>
                </div>
